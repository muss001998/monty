 ...
 * @prev: this will always point to the previous element of the stack (or queue)
 * @next: this will always points to the next element of the stack (or queue)
 *
 ...
 * @arg: value
 * @file: this will rep a pointer to monty file
 * @content: this is the  line content
 * @lifi: this is the flag change stack <-> queue
 ...
 * @f: rep the function to handle the opcode
 *
